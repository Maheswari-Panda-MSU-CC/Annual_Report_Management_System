...
export async function POST(request: Request) {
  try {
    ...
    req.input('university', sql.NVarChar(200), refresherDetail.university || null)
    req.input('institute', sql.NVarChar(200), refresherDetail.institute || null)
    req.input('department', sql.NVarChar(200), refresherDetail.department || null)
    req.input('centre', sql.NChar(200), refresherDetail.centre || null)
