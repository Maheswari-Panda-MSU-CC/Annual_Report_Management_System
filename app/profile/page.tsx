            ...
            <div className="flex items-center justify-between">
              ...
              {!isEditingPersonal ? (
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" onClick={handleCancelPersonal} className="flex items-center gap-2">
                    <X className="h-4 w-4" />
                    Cancel
                  </Button>
                </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleSaveExperience} size="sm" variant="outline" className="flex items-center gap-2">
                  <Save className="h-4 w-4" />
                  Save
                </Button>
              </div>
                    ...
                    <TableRow key={entry.id}>
                      ...
                      <TableCell>
                        <Select
                          ...
                          onChange={(value) => updateExperienceEntry(entry.id, "natureOfJob", value)}
                        >
                      ...
                      <TableCell>
                        <Select
                          ...
                          onChange={(e) => updateExperienceEntry(entry.id, "typeOfTeaching", e.target.value)}
                        >
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleSavePostDoc} size="sm" variant="outline" className="flex items-center gap-2">
                  <Save className="h-4 w-4" />
                  Save
                </Button>
              </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleSaveEducation} size="sm" variant="outline" className="flex items-center gap-2">
                  <Save className="h-4 w-4" />
                  Save
                </Button>
              </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Please tick if you DON'T have any information to submit in the following academic years
                </CardDescription>
              </div>
              <div className="flex gap-2">
                <Button
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
                <p className="text-sm text-yellow-800">
                  <strong>Note:</strong> Please check the academic years for which you do NOT have any information to
                  submit. This helps in generating accurate reports and understanding data availability across different
                  academic years.
                </p>
              </div>
            </div>
